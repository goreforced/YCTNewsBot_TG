...
CHANNEL_ID = os.getenv("CHANNEL_ID")  # Берем из окружения
...
Заголовок (до 80 символов) в стиле новостного канала, без лишних слов вроде "Заголовок" или "Новость".
[Первый абзац: 1-2 предложения, основная суть новости. Чётко и без воды.]
[Второй абзац: уточняющие детали, важные цифры или контекст из статьи.]
[Третий абзац (необязательно): краткий итог или дополнительная информация из статьи.]

Требования:
- Отвечай на русском языке.
- Строго используй квадратные скобки для каждого абзаца.
- Бери данные ТОЛЬКО из статьи, никаких выдумок или дополнительных фактов.
- Без аналитики, предположений, выводов, мнений.
- Не добавляй фразы вроде "сообщает источник" или "по данным".
- Без маркеров и списков.
